...
the mechanism, not as a prediction: the deviation is a uniform-convergence quantity bounded by
the calibration sample alone. We therefore claim the direction, not a rate.
