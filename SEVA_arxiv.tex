...
\label{app:detail}
The tables in this appendix give the per-condition detail behind every summary figure in
...
the main text. Each is calibrated non-oracle on clean coherence alone, so no row borrows
