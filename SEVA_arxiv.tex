...
soft keyword signal we ablate (Appendix~\ref{app:signals}): a detector validated only
...
Appendix~\ref{app:signals} gives the full signal inventory and its in-domain separation. The
...
\subsection{Signal Inventory (Composite Ablation)}
\label{app:signals}
...
\subsection{Geometric Core vs.\ Composite}
\label{app:core}
...
\subsection{Encoder-Invariance Detail}
\label{app:encoder}
...
\subsection{Reproduced Head-to-Head Detail}
\label{app:h2h}
...
\subsection{Million-Document Scale Detail}
\label{app:scale}
...
\subsection{Cross-Domain Detection Detail}
\label{app:xdomain}
...
\subsection{Complete Sensitivity Measurements}
\label{app:sens}
