...
stream---a label-free estimator of the same quantity, biased upward by whatever poison that
stream retrieves. We have not measured that estimator, and report the distinction rather than
assume the two coincide. In-domain this places the geometric gate at
