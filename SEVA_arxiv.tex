...
\begin{axis}[width=\columnwidth, height=3.3cm,
  ...
  xmin=0, xmax=11, ymin=0.11, ymax=0.33, xtick={1,5,10},
...
\begin{axis}[width=\columnwidth, height=4.1cm,
  ...
  xmin=0, xmax=11, ymin=0.09, ymax=0.31, xtick={1,5,10},
...
another---the mutual similarity the attack exists to avoid (\S\ref{subsec:boundary} reports the
