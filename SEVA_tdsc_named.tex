...
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem Manuscript received XX XXX 2026; revised XX XXX 2026.\protect\\
V. Varadharajan and Abishek V. P. T. are independent researchers.\protect\\
Corresponding author: V. Varadharajan (e-mail: vv0366@srmist.edu.in).}}
...
\emph{Use of AI in the experiments.} Two locally hosted open-weight models generated and judged experimental data; neither is part of the detector. \texttt{mistral:7b-instruct} rewrote host-anchored clone passages (\S\ref{subsec:boundary}); \texttt{gpt-oss:20b} at temperature $0$ judged answer corruption end to end. Data so generated is labelled as such in the released artifacts. SEVA itself calls no language model.
\emph{Financial support.} This research received no external grant funding. \emph{Conflicts of interest.} The authors declare none. \emph{Data and code availability.} The frozen detector, reproduction toolkit, generated clone datasets, and a result file behind every headline number are available at \url{https://github.com/varadharajanv0310/SEVA-IEEE}; corpora and poison are gated by order-sensitive SHA-256 hashes recorded in each result file, so a reproduction that does not match fails closed rather than diverging silently.
...
% ---------------------------------------------------------------------------
% TODO(author): IEEE Computer Society style expects a short biography per author
% for the FINAL version (roughly 100 words each, photo optional). Fill these in
% or delete the block if the submission version does not require them.
% ---------------------------------------------------------------------------
\begin{IEEEbiographynophoto}{V. Varadharajan}
TODO: biography.
\end{IEEEbiographynophoto}

\begin{IEEEbiographynophoto}{Abishek V. P. T.}
TODO: biography.
\end{IEEEbiographynophoto}
