...
% ---------------------------------------------------------------------------
% Anonymous artifact link for double-blind review.
% Mint a mirror at https://anonymous.4open.science (sign in with GitHub, point it
% at varadharajanv0310/SEVA-IEEE, set an expiry past the review period) and replace
% the default below with \url{...}. Nothing else needs to change.
% ---------------------------------------------------------------------------
\newcommand{\ANONREPO}{[anonymized repository link; a read-only mirror is provided to reviewers via the editorial office]}
...
\thanks{Author affiliations and corresponding-author details: [Anonymized for Double-Blind Review].}}
